                ...
                n.find("[style]").each(function (i, r) {
                    ...
                    e.each(a.domEventsList, function (e, i) {
                        ...
                        s.length &&
                            ...
                            s.attr(a.CSP_ATTRIB) ? (r = s.attr(a.CSP_ATTRIB)) : ((r = t.uniqId()), (a.domElementEvents[r] = [])),
        ...
        (i.prototype = {
                                            ...
                                            o = function () {
                                                ...
                                                return (
                                                    ...
                                                    r.cancelled
                                                        ...
                                                        : (c.length === r.size() && (s ? u.reject.apply(null, c) : u.resolve.apply(null, c)), void (d.length && ((a = d.shift()), n(a), a.run())))
                                                );
                                            };
                                        d.length && l++ < i;
                ...
                (s.options = i),
                    ...
                    a
                        ...
                        : (s._resetErrors(),
                          ...
                          s.$parent.hasClass("file-loading") && (s.$container.insertBefore(s.$parent), s.$parent.remove())),
                    ...
                    (i.resumableManager = {
                        init: function (e, t, a) {
                            ...
                            (r.logs = []),
                                ...
                                i.showPreview &&
                                    ...
                                    r.$thumb && r.$thumb.length && ((r.$progress = r.$thumb.find(".file-thumb-progress")), (r.$btnDelete = r.$thumb.find(".kv-file-remove")))),
                                (r.chunkSize = 1024 * i.resumableUploadOptions.chunkSize),
                                (r.chunkCount = r.getTotalChunks());
                        },
                        logAjaxError: function (e, t, a) {
                            i.resumableUploadOptions.showErrorLog && i._log(r.ajaxError, { status: e.status, error: a, text: e.responseText || "" });
                        },
                        reset: function () {
                            ...
                            (a.completed = !0),
                                ...
                                "success" === e
                                    ? ((r.uploadedSize += a.file.size),
                                      i.showPreview && (i._setProgress(101, l), i._setThumbStatus(o, "Success"), i._initUploadSuccess(a.chunksProcessed[n].data, o)),
                                    ...
                                    : "cancel" !== e &&
                                      (i.showPreview && (i._setThumbStatus(o, "Error"), i._setPreviewError(o, !0), i._setProgress(101, l, i.msgProgressError), i._setProgress(101, i.$progress, i.msgProgressError), (i.cancelling = !0)),
                                      i.$errorContainer.find('li[data-file-id="' + d.fileId + '"]').length ||
                                          ((t = i.msgResumableUploadRetriesExceeded.setTokens({ file: a.fileName, max: i.resumableUploadOptions.maxRetries, error: a.error })), i._showFileError(t, d))),
                        ...
                        upload: function () {
                            ...
                            e = setInterval(function () {
                                ...
                                if (
                                    (a.checkAborted(e),
                                    "new" === o && (i.lock(), (o = "processing"), (l = n.shift()), r.initStats(l), r.stack[l] && (a.init(l, r.stack[l], r.getIndex(l)), a.testUpload(), a.uploadResumable())),
                        ...
                        uploadResumable: function () {
                            ...
                            r.testing ||
                                t
                                    .run(i.resumableUploadOptions.maxThreads)
                                    .done(function () {
                        ...
                        testUpload: function () {
                            ...
                            return u.testUrl
                                ? ((c.testing = !0),
                                  (a = new FormData()),
                                  (r = p.stack[f]),
                                  i._setUploadData(a, { fileId: f, fileName: r.fileName, fileSize: r.size, fileRelativePath: r.relativePath, chunkSize: c.chunkSize, chunkCount: c.chunkCount }),
                                  (n = function (e) {
                                ...
                                (m = new FormData()),
                                    ...
                                    (w = function (t, o, d) {
                                        ...
                                        var c = i.uploadParamNames,
                                            ...
                                            g = [u, e, a, l, s, h];
                                        t.error
                                            ? (f.showErrorLog && i._log(r.retryStatus, { retry: a + 1, filename: s.fileName, chunk: e }), s.pushAjax(e, a + 1), (s.error = t.error), i._raise("filechunkerror", g))
                                            : ((s.logs[t[p]] = !0),
                                    ...
                                    (b = function (t, r, o) {
                                        return i._isAborted()
                                            ...
                                            : ((h = i._getOutData(m, t)), (s.error = o), s.logAjaxError(t, r, o), i._raise("filechunkajaxerror", [u, e, a, l, s, h]), s.pushAjax(e, a + 1), void n.reject("try failed"));
                                    }),
                                    (_ = function () {
            ...
            _initTemplateDefaults: function () {
                ...
                (i =
                    ...
                    (N.defaults = {
                        ...
                        previewContentTemplates: { generic: E, html: F, image: S, text: I, office: A, gdocs: D, video: z, audio: M, flash: j, object: U, pdf: $, other: R },
                ...
                (i.previewCache = {
                    ...
                    get: function (e, a) {
                        ...
                        return g && g.length
                            ? ((a = void 0 === a ? !0 : a),
                              ...
                              (r = m ? v(o, g, s, d, l, u, c) : v("generic", g, s, d, l, u, c, o).setTokens({ content: p.content[e] })),
                    ...
                    add: function (e, a, r, n) {
                        ...
                        return e && e.length
                            ? ((o = e.length - 1),
                              ...
                              n && l.content ? ((o = l.content.push(e[0]) - 1), (l.config[o] = a), (l.tags[o] = r)) : ((l.content = e), (l.config = a), (l.tags = r)),
                    ...
                    footer: function (e, a, r) {
                        ...
                        return (
                            ...
                            i._getLayoutTemplate("footer").setTokens({ progress: i._renderThumbProgress(), actions: o, caption: s, size: i._getSize(r), width: d, indicator: "" })
                        );
                    },
                }),
                    i.previewCache.init();
            ...
            _zoneDragEnter: function (i) {
                ...
                return (
                    ...
                    a.isDisabled || !n
                        ? ((i.originalEvent.dataTransfer.effectAllowed = "none"), void (i.originalEvent.dataTransfer.dropEffect = "none"))
                        : void (a._raise("fileDragEnter", { sourceEvent: i, files: r.types.Files }) && t.addCss(a.$dropZone, "file-highlighted"))
                );
            },
                ...
                (t.autoOrientImageInitial || a) &&
                    t.getFrames(".file-preview-initial").each(function () {
                        ...
                        s &&
                            ...
                            a ? r.css("image-orientation", t.autoOrientImageInitial ? "from-image" : "none") : t.setImageOrientation(r, n, s.exif.Orientation, l)),
                            i++;
                    });
            },
            ...
            _getZoomButton: function (e) {
                ...
                return (
                    ("fullscreen" !== e && "borderless" !== e && "toggleheader" !== e) || (n += ' data-toggle="button" aria-pressed="false" autocomplete="off"'),
                ...
                a.on(e + ".bs.modal", function (n) {
                    ...
                    a.data("fileinputPluginId") === i.$element.attr("id") && i._raise("filezoom" + e, r(n)),
                        "shown" === e &&
                            ...
                            a.hasClass("file-zoom-fullscreen") && (i._maximizeZoomDialog(), t.checkFullScreen() ? o.addClass("active").attr("aria-pressed", "true") : l.addClass("active").attr("aria-pressed", "true")));
                });
            },
            _initZoom: function () {
                var i,
            ...
            _initZoomButtons: function () {
                ...
                return n.length < 2
                    ...
                    : (l.show(),
                      s.show(),
                      void (o && ((t = e(n[0])), (i = e(n[o - 1])), l.removeAttr("disabled"), s.removeAttr("disabled"), t.length && t.attr("id") === r && l.attr("disabled", !0), i.length && i.attr("id") === r && s.attr("disabled", !0))));
            },
            ...
            _refreshPreview: function () {
                ...
                (i._inputFileCount() || i.isAjaxUpload) &&
                    i.showPreview &&
                    i.isPreviewable &&
                    (i.isAjaxUpload && i.fileManager.count() > 0 ? ((t = e.extend(!0, {}, i.fileManager.stack)), i.fileManager.clear(), i._clearFileInput()) : (t = i.$element.get(0).files),
            ...
            _resetPreview: function () {
                ...
                i.previewCache.count(!0)
                    ? ((e = i.previewCache.out()), i._setPreviewContent(e.content), i._setInitThumbAttr(), (t = i.initialCaption ? i.initialCaption : e.caption), i._setCaption(t))
            ...
            _initUploadSuccess: function (i, a, r) {
                ...
                return !m.showPreview || "object" != typeof i || e.isEmptyObject(i)
                    ...
                    : (void 0 !== i.initialPreview &&
                          ...
                          c.length && (m._mergeArray("initialPreview", c), m._mergeArray("initialPreviewConfig", u), m._mergeArray("initialPreviewThumbTags", p)),
                          void 0 !== a
                              ? r
                                  ? ((f = a.attr("id")), (g = m._getUploadCacheIndex(f)), null !== g && (m.uploadCache[g] = { id: f, content: c[0], config: u[0] || [], tags: p[0] || [], append: n }))
                                  : ((l = m.previewCache.add(c[0], u[0], p[0], n)),
                                    (o = m.previewCache.get(l, !1)),
                                    (s = t.createElement(o).hide().insertAfter(a)),
            ...
            _uploadSingle: function (i, a, r) {
                ...
                w.enableResumableUpload ||
                    (w.showPreview && ((o = w.fileManager.getThumb(a)), (u = o.find(".file-thumb-progress")), (s = o.find(".kv-file-upload")), (d = o.find(".kv-file-remove")), u.show()),
                    0 === _ ||
                        !x ||
                            ...
                            (n = w._getOutData(C, p, l)),
                                ...
                                setTimeout(function () {
                                    t.isEmpty(l) || t.isEmpty(l.error)
                                        ? (w.showPreview && (w._setThumbStatus(o, "Success"), s.hide(), w._initUploadSuccess(l, o, r), w._setProgress(101, u)), w._raise("fileuploaded", [n, g, i]), r ? v() : w.fileManager.remove(o))
                                        : ((c = !0),
                                          ...
                                          r && v(),
                                          w._setProgress(101, w._getFrame(g).find(".file-thumb-progress"), w.msgUploadError));
                                }, w.processDelay);
                        }),
                        (m = function () {
                                      ...
                                      (c.each(function () {
                                          ...
                                          t.removeClass("file-uploading"),
                                              ...
                                              0 === u.length || -1 !== e.inArray(d, u)
                                                  ? (s._setPreviewError(t, !0), s.retryErrorUploads || (t.find(".kv-file-upload").hide(), s.fileManager.remove(t)))
                                                  : (t.find(".kv-file-upload").hide(), s._setThumbStatus(t, "Success"), s.fileManager.remove(t)),
                        ...
                        (r = function (t, i, a) {
                            ...
                            (o = s._parseError(g, t, a)),
                                ...
                                s.showPreview &&
                                    ...
                                    s._setProgress(101, s.$progress, s.msgAjaxProgressError.replace("{operation}", g)));
                        });
                    var m = 0;
                                    ...
                                    ? ((a = o.hasClass("file-preview-error")),
                                      ...
                                      void o.fadeOut("slow", function () {
                                          t.cleanZoomCache(i._getZoom(l)),
                                              ...
                                              l &&
                                                  a &&
                                                  i.$errorContainer.find('li[data-thumb-id="' + l + '"]').fadeOut("fast", function () {
                    ...
                    a.find(n).each(function () {
                        ...
                        if (!t.isEmpty(p) && void 0 !== f) {
                            ...
                            (y = parseInt(y.replace(t.INIT_FLAG, ""))),
                                ...
                                (m = e.extend(!0, {}, { url: i._encodeURI(p), type: "POST", dataType: "json", data: e.extend(!0, {}, { key: f }, b) }, i._ajaxDeleteSettings)),
            ...
            _getSize: function (t, i) {
                ...
                return e.isNumeric(t) && e.isNumeric(o)
                    ? ("function" == typeof l
                          ...
                          : 0 === o
                          ? (r = "0.00 B")
                          : ((a = Math.floor(Math.log(o) / Math.log(1024))), i || (i = ["B", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"]), (r = 1 * (o / Math.pow(1024, a)).toFixed(2) + " " + i[a])),
            ...
            _generatePreviewTemplate: function (i, a, r, n, o, l, s, d, c, u, p, f, g, m) {
                var h,
                    ...
                    I = F ? "other" : i;
                return (
                    (v = 400 > x ? b.previewSettingsSmall[I] || b.defaults.previewSettingsSmall[I] : b.previewSettings[I] || b.defaults.previewSettings[I]),
                    v &&
            ...
            _updateFileDetails: function (e, i) {
                ...
                !c && s.fileManager.count() > 0 ? ((l = s.fileManager.getFirstFile()), (a = l.nameFmt)) : (a = c ? s.slug(c) : "_"),
            ...
            _setProgress: function (e, i, a, r) {
                ...
                if (((i = i || n.$progress), i.length)) {
                    ...
                    e >= 100 && (r = ""),
                        t.isEmpty(c) ||
                            ((o = s && l > s && 100 >= e ? c.setTokens({ percent: s, status: n.msgUploadThreshold }) : c.setTokens({ percent: l, status: e > 100 ? n.msgUploadEnd : l + "%" })),
                            (r = r || ""),
            ...
            _checkDimensions: function (e, i, a, r, n, o, l) {
                ...
                !t.isEmpty(g) &&
                    ...
                    (u = "Small" === i ? d >= g : g >= d),
                    u || ((s = p["msgImage" + o + i].setTokens({ name: n, size: g })), p._showFileError(s, l), p._setPreviewError(r)));
            },
                ...
                (c && u) ||
                    ...
                    f
                        ? ((i = a),
                          ...
                          (l = e(document.createElement("div")).appendTo(n.find(".kv-file-content"))),
                          (o = e(document.createElement("span")).insertBefore(i)),
                          i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(l))
                        : (p = !i.is(":visible")),
                ...
                return f.canOrientImage
                    ...
                    : ((p = t.getZoomSelector(r, " img")),
                      ...
                      (u = c ? c["0th"][piexif.ImageIFD.Orientation] : null)
                          ? (f.setImageOrientation(i, e(p), u, f._getFrame(r)), f._raise("fileimageoriented", { $img: i, file: a }), void f._validateImage(r, n, o, l, s, d, c))
                    ...
                    m
                        .one("load", function () {
                            (d = f.width()),
                                ...
                                u.fileManager.addImage(i, { ind: g, img: m, thumb: f, pid: t, typ: r, siz: n, validated: !1, imgData: o, exifObj: l }),
                                f.data("exif", l),
            ...
            _getResizedImage: function (i, a, r, n) {
                ...
                if (
                    ...
                    (m = [i, E, F]),
                    (!f || !x || (C >= w && y >= b)) && (x && f && h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized"), !x))
                )
            ...
            _renderButton: function (e) {
                ...
                return (
                    ...
                    a.setTokens({ type: d, css: r, title: n, status: s, icon: o, label: l })
                );
            },
            ...
            _renderFileFooter: function (e, i, a, r, n) {
                ...
                return (
                    (a = s._getSize(a)),
                    (l = { type: e, caption: i, size: a, width: r, progress: "", indicator: w }),
            ...
            _renderFileActions: function (e, t, i, a, r, n, o, l, s, d, c, u) {
                ...
                return (
                    a && (w = p._getLayoutTemplate("actionDelete").setTokens({ removeClass: T, removeIcon: y.removeIcon, removeTitle: y.removeTitle, dataUrl: g, dataKey: v, key: s })),
                    t && (b = p._getLayoutTemplate("actionUpload").setTokens({ uploadClass: y.uploadClass, uploadIcon: y.uploadIcon, uploadTitle: y.uploadTitle })),
                    i &&
                        ((_ = p._getLayoutTemplate("actionDownload").setTokens({ downloadClass: y.downloadClass, downloadIcon: y.downloadIcon, downloadTitle: y.downloadTitle, downloadUrl: c || p.initialPreviewDownloadUrl })),
                        (_ = _.setTokens({ filename: u, key: s }))),
                    r && (m = p._getLayoutTemplate("actionZoom").setTokens({ zoomClass: y.zoomClass, zoomIcon: y.zoomIcon, zoomTitle: y.zoomTitle })),
                    n && d && ((f = "drag-handle-init " + y.dragClass), (h = p._getLayoutTemplate("actionDrag").setTokens({ dragClass: f, dragTitle: y.dragTitle, dragIcon: y.dragIcon }))),
            ...
            readFiles: function (i) {
                ...
                var a,
                    ...
                    v = function (t, n, o, l, s, d) {
                        var c,
                            p = e.extend(!0, {}, r._getOutData(null, {}, {}, i), { id: o, index: l, fileId: s }),
                ...
                r.fileManager.clearImages(),
                    ...
                    (a = function (w) {
                        ...
                        if (U) {
                            if (((S = C.getId(U)), g > 0)) for (x = 0; g > x; x++) (E = f[x]), (F = r.msgFileTypes[E] || E), (q += 0 === x ? F : ", " + F);
                            ...
                            if ((t.isEmpty(m) || (N = new RegExp("\\.(" + m.join("|") + ")$", "i")), (y = Z.toFixed(2)), (r.isAjaxUpload && C.exists(S)) || r._getFrame($, !0).length)) {
                                ...
                                return (
                                    ...
                                    void (r.isAjaxUpload
                                        ? setTimeout(function () {
                                              r.duplicateErrors.push(T), r._raise("fileduplicateerror", [U, S, L, y, $, w]), a(w + 1), r._updateFileDetails(u);
                                          }, r.processDelay)
                                        : (r._showError(T, Y), r.unlock(), (u = 0), r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                                );
                            }
                            if (r.maxFileSize > 0 && Z > r.maxFileSize) return (T = r.msgSizeTooLarge.setTokens({ name: L, size: y, maxSize: r.maxFileSize })), void v(T, U, $, w, S);
                            if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize)) return (T = r.msgSizeTooSmall.setTokens({ name: L, size: y, minSize: r.minFileSize })), void v(T, U, $, w, S);
                            if (!t.isEmpty(f) && t.isArray(f)) {
                                for (x = 0; x < f.length; x += 1) (P = f[x]), (A = p[P]), (W += A && "function" == typeof A && A(U.type, t.getFileName(U)) ? 1 : 0);
                                if (0 === W) return (T = r.msgInvalidFileType.setTokens({ name: L, types: q })), void v(T, U, $, w, S);
                            }
                            if (0 === W && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(N) && ((k = t.compare(L, N)), (W += t.isEmpty(k) ? 0 : k.length), 0 === W))
                                return (T = r.msgInvalidFileExtension.setTokens({ name: L, extensions: h })), void v(T, U, $, w, S);
                            if (!r._canPreview(U))
                                return (
                                    ...
                                    void setTimeout(function () {
                                        I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [U, $, w]);
                                    }, 10)
                                );
                            (D = R(U.type, L)),
                                (z = B(U.type, L)),
                                ...
                                (n.onload = function (i) {
                                    var a,
                                        ...
                                        m = function (e) {
                                            ...
                                            (t.onerror = function (e) {
                                                ...
                                                (t.onload = function (e) {
                                                    return r.isAjaxUpload && !r._raise("filebeforeload", [U, w, n])
                                                        ? ((V = !0), r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable())
                                                        : (r._previewFile(w, U, e, H, s), r._initFileActions(), void G());
                                                }),
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            (f = t.getMimeType(a, "", "")),
                                            t.isEmpty(f) && ((u = t.arrayBuffer2String(n.result)), (f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, U.type))),
                                            (s = { name: L, type: f }),
                                            (D = R(f, "")),
                                            (z = B(f, "")),
                                            (M = O(f, "")),
                                    ...
                                    return r.isAjaxUpload && !r._raise("filebeforeload", [U, w, n])
                                        ? ((V = !0), r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable())
                                        : (r._previewFile(w, U, i, H, s), r._initFileActions(), void G());
                                }),
                                (n.onprogress = function (e) {
                                    if (e.lengthComputable) {
                                        var t = (e.loaded / e.total) * 100,
                                            i = Math.ceil(t);
                                        (T = d.setTokens({ index: w + 1, files: u, percent: i, name: L })),
                                            setTimeout(function () {
                                                V || l.html(T);
                                            }, r.processDelay);
                                    }
            ...
            lock: function (e) {
                var t = this,
                    i = t.$container;
                return (
                    t._resetErrors(), t.disable(), !e && t.showCancel && i.find(".fileinput-cancel").show(), !e && t.showPause && i.find(".fileinput-pause").show(), t._raise("filelock", [t.fileManager.stack, t._getExtraData()]), t.$element
                );
            },
            unlock: function (e) {
                var t = this,
            ...
            resume: function () {
                ...
                return e.enableResumableUpload
                    ? (e.paused ? e._toggleResumableProgress(e.progressPauseTemplate, e.msgUploadResume) : (t = !0),
                      (e.paused = !1),
                      t && e._toggleResumableProgress(e.progressInfoTemplate, e.msgUploadBegin),
                      setTimeout(function () {
                          i.upload();
                      }, e.processDelay),
                      e.$element)
                        ...
                        i._getThumbs().each(function () {
                            ...
                            a.removeClass("file-uploading"),
                                s.attr("title") === l.indicatorLoadingTitle &&
                                    (i._setThumbStatus(a, "Paused"), (t = n.setTokens({ pendingTime: i.msgPaused, uploadSpeed: "" })), (i.paused = !0), i._setProgress(o, a.find(".file-thumb-progress"), o + "%", t)),
                ...
                switch (
                    ...
                    this.each(function () {
                        ...
                        s ||
                            ...
                            (o = e.extend(!0, {}, e.fn.fileinput.defaults, p, e.fn.fileinputLocales.en, u, d, l.data())),
                            (s = new i(this, o)),
                            l.data("fileinput", s)),
